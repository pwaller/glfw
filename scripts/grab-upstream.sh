...
EOF
  ...
  # Workaround naming difference between upstream and generate-wayland-protocols.sh.
  (cd v3.3/glfw/glfw/src/ && ln -s wayland-xdg-decoration{-unstable-v1,}-client-protocol.h)
}
